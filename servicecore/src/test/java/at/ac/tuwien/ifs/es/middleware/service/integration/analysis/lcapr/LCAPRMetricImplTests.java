...
/**
 * This class defines test cases for {@link LCAPRMetricImpl}.
 *
 * @author Kevin Haller
 * @version 1.0
 * @since 1.0
...
@ContextConfiguration(classes = {SimpleSPARQLService.class, RDF4JLuceneFullTextSearchDAO.class,
    ...
    PageRankCentralityMetricWithGremlinService.class, LCAPRMetricImpl.class})
...
public class LCAPRMetricImplTests extends LCAPRMetricServiceTests {
