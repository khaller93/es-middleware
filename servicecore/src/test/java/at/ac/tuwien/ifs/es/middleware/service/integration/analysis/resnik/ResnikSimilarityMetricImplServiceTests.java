...
@ContextConfiguration(classes = {SimpleSPARQLService.class, RDF4JLuceneFullTextSearchDAO.class,
    ...
    LCAOnTheFlyService.class, ResnikSimilarityMetricServiceImpl.class})
...
public class ResnikSimilarityMetricImplServiceTests extends ResnikSimilarityMetricServiceTests {
