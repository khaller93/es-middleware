 ...
 */
@Component
public class WineOntologyDatasetResource extends ExternalKGResource {

  private static Model testModel;

  static {
    try (InputStream testDatasetIn = WineOntologyDatasetResource.class.getResourceAsStream(
        "/datasets/wine.ttl")) {
  ...
  @Autowired
  public WineOntologyDatasetResource(@Qualifier("getSparqlDAO") KGSparqlDAO sparqlDAO,
