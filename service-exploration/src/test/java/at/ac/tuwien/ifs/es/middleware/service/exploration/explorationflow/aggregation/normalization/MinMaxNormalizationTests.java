package at.ac.tuwien.ifs.es.middleware.service.exploration.explorationflow.aggregation.normalization;
...
@ContextConfiguration(classes = {SimpleSPARQLService.class, RDF4JLuceneFullTextSearchDAO.class,
    ...
    ThreadPoolConfig.class, PrimaryKGDAOConfig.class, RDF4JDAOConfig.class, MinMaxNormalisation.class})
