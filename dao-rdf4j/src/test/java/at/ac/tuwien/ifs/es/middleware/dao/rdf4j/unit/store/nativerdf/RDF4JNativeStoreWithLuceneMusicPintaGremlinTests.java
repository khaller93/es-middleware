...
@ContextConfiguration(classes = {
    RDF4JNativeStoreWithLuceneSparqlDAO.class, ClonedInMemoryGremlinDAO.class,
    PrimaryKGDAOConfig.class, RDF4JDAOConfig.class, RDF4JLuceneFullTextSearchDAO.class,
    ThreadPoolConfig.class, DAOScheduler.class, SchedulerPipeline.class, MapDBDummy.class,
    DAODependencyGraphService.class, MusicPintaInstrumentsResource.class
})
